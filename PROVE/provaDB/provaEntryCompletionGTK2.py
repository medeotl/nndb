...
class EntryCompletionDemo(gtk.Dialog):
    ...
    def __init__(self, parent=None):
        ...
        entry.connect("activate", self.on_enter_pressed)
        ...
        self.completion_model = self.__create_completion_model()
    ...
    def on_enter_pressed(self, widget):
        print("'%s' è stato inserito nel completion model") % widget.get_text()
        iter = self.completion_model.append()
        self.completion_model.set(iter, 0, widget.get_text())
        widget.set_text("")
